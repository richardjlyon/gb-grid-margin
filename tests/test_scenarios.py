...
def test_build_all_returns_named_payloads(tmp_path):
    ...
    # Both days are now fully covered: NESO published the 24 June 2026 embedded data
    # (~3-week lag) in July 2026, so its scenario renders alongside 8 Jan 2025.
    assert "scenario_8-january-2025-costliest-day" in names
    assert "scenario_24-june-2026-emergency" in names
